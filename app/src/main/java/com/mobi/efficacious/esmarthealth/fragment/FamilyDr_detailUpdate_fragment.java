...
public class FamilyDr_detailUpdate_fragment  extends Fragment {
    View myview;
    private static final String PREFRENCES_NAME = "myprefrences";
    SharedPreferences settings;
    String intResId,intDocId;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((MainActivity) getActivity()).setActionBarTitle("Doctor Detail");
        ...
        try
        {
            intDocId = getArguments().getString("intDocId");
            DRName = getArguments().getString("vchName");
            Gender_Selection = getArguments().getString("vchGender");
            DRAddress = getArguments().getString("vchAddress");
            DRMobileNo = getArguments().getString("vchMobileNo");
            DREmailId = getArguments().getString("vchEmailId");
            DRQualification = getArguments().getString("vchQualification");
            DrFromTime = getArguments().getString("dtDrFromtiming");
            DrToTime = getArguments().getString("dtDrTotiming");
            ...
            et_DrName.setText(DRName);
            address.setText(DRAddress);
            et_DrMobileNo.setText(DRMobileNo);
            et_Dr_emailId.setText(DREmailId);
            et_Dr_Qualification.setText(DRQualification);
            FromTiming.setText(DrFromTime);
            ToTiming.setText(DrToTime);
        }catch (Exception ex)
        {
    ...
    public void UpdateDAta() {
        try {
            ...
            progressDoalog.show();
            DoctorDetail update = new DoctorDetail(Integer.parseInt(intDocId),Integer.parseInt(intResId),DRName,Gender_Selection,DRAddress,DRMobileNo,DREmailId,DRQualification,DrFromTime,DrToTime);
            DataService service = RetrofitInstance.getRetrofitInstance().create(DataService.class);
            Call<ResponseBody> call = service.Update_DoctorDetails(update);
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    ...
                    try {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            Toast.makeText(getActivity(), "Doctor details Updated Succesfully", Toast.LENGTH_SHORT).show();
                            try {
                                FamilyDr_Tab familyDr_tab = new FamilyDr_Tab ();
                                MainActivity.fragmentManager.beginTransaction().replace(R.id.content_main, familyDr_tab).commitAllowingStateLoss();
                            } catch (Exception ex) {
